...
export const demoServices: Service[] = [
  {
    ...
    description: {
      fr: "1 concept + 2 révisions, livrable print-ready.",
      en: "1 concept + 2 revisions, print-ready delivery.",
    },
    priceFrom: "180€",
    features: [
      { fr: "Format au choix (A5, A6, story…)", en: "Format of choice (A5, A6, story…)" },
      { fr: "Fichiers print + web", en: "Print + web files" },
  ...
  },
  {
    ...
    description: {
      fr: "Teaser 10–20s pour réseaux sociaux.",
      en: "10–20s teaser for social networks.",
    },
    priceFrom: "450€",
    features: [
